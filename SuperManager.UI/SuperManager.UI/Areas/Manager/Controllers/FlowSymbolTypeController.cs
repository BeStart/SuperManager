...
namespace SuperManager.UI.Areas.Manager.Controllers
{
    public class FlowSymbolTypeController : BaseManagerListController
    {
        ...
        public ActionResult List(string searchKey = "", int pageIndex = 1)
        {
            ...
            List<DBFlowSymbolTypeModel> modelList = DALFactory.FlowSymbolType.Page(searchKey, pageIndex, ConfigHelper.ManagerPageSize, ref this.totalCount, ref this.pageCount);
